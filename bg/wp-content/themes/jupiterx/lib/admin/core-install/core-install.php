	...
	public function install_notice() {
		...
		<div id="jupiterx-core-install-notice" class="updated jupiterx-core-install-notice notice is-dismissible">
			...
			?>
				...
				<p><?php esc_html_e( 'To complete the installation and unlock more features, we highly recommend to activate Jupiter X Core plugin.', 'jupiterx' ); ?> <a class="jupiterx-core-install-notice-link" target="_blank" href="https://themes.artbees.net/docs/getting-started-with-jupiter-x/"><?php esc_html_e( 'Learn More', 'jupiterx' ); ?>.</a></p>
