...
<div id="mk-process-<?php echo esc_attr( $id ); ?>" class="mk-process-steps process-steps-<?php echo esc_attr( $step ); ?> <?php echo esc_attr( $el_class ) . ' ' . esc_attr( 'jupiter-donut-' . $visibility ); ?>">
