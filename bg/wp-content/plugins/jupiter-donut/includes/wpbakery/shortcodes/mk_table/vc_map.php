...
vc_map(array(
    ...
    "params" => array(
        ...
        array(
            "type" => "textarea_html",
            "holder" => "div",
            "heading" => __("Table HTML content. You can use below sample and create your own data tables.", 'jupiter-donut') ,
            "param_name" => "content",
...
<td><strong>$20.00</strong></td>
            ...
            "description" => __("Paste your table HTML code here.", 'jupiter-donut')
        ) ,
