...
switch ( $column ) {
	...
	$hover_overlay = ! empty( $hover_overlay ) ? $hover_overlay : '';
...
<article id="<?php the_ID(); ?>" class="mk-portfolio-item portfolio-item-<?php echo $id; ?> mk-portfolio-masonry-item <?php echo implode( ' ', $item_classes ); ?>">
	<div class="item-holder">
		   <div class="featured-image js-taphover
			<?php
			if ( $view_params['permalink_icon'] == 'false' && $view_params['zoom_icon'] == 'false' ) {
				echo 'buttons-disabled';}
?>
">
						...
						<img  class="portfolio-image" alt="<?php the_title_attribute(); ?>" title="<?php the_title_attribute(); ?>" src="<?php echo $featured_image_src['dummy']; ?>" <?php echo $featured_image_src['data-set']; ?> width="<?php echo esc_attr( $image_size_atts['width'] ); ?>" height="<?php echo esc_attr( $image_size_atts['height'] ); ?>"/>
									...
									echo mk_get_shortcode_view(
										'mk_portfolio', 'components/hover-overlay', true, [
...
?>
					...
					<?php if ( $view_params['hover_scenarios'] != 'none' ) : ?>
						<div class="icons-holder">
							<?php
								echo mk_get_shortcode_view(
									'mk_portfolio', 'components/permalink-icon', true, [
										'permalink_icon' => $view_params['permalink_icon'],
										'permalink_icon_name' => $view_params['permalink_icon_name'],
										'target' => $view_params['target'],
									]
								);
								echo mk_get_shortcode_view(
									'mk_portfolio', 'components/zoom-icon', true, [
										'zoom_icon' => $view_params['zoom_icon'],
										'permalink_icon' => $view_params['permalink_icon'],
										'zoom_icon_name' => $view_params['zoom_icon_name'],
									]
								);
							?>
						</div>
											...
											<?php
											if ( $view_params['hover_scenarios'] == 'slidebox' ) {
												echo $hover_overlay; }
?>
>
							<div class="add-middle-align">
								<?php
									echo mk_get_shortcode_view(
										'mk_portfolio', 'components/title', true, [
											'permalink_icon' => $view_params['permalink_icon'],
											'target' => $view_params['target'],
										]
									);
									echo mk_get_shortcode_view(
										'mk_portfolio', 'components/meta-category-date', true, [
											'meta_type' => $view_params['meta_type'],
										]
									);
								?>
