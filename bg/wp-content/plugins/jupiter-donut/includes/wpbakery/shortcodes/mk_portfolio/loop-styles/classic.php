    ...
    switch ($view_params['column']) {
        case 1:
            if ($view_params['layout'] == 'full') {
                    ...
                    $width = round(($content_width / 100) * $grid_width) - 62;
            }
            $item_classes[] = 'one-column';
            break;
        case 2:
            if ($view_params['layout'] == 'full') {
                    $width = round($grid_width / 2) - 42;
            } else {
                    $width = round((($content_width / 100) * $grid_width) / 2) - 47;
            }
