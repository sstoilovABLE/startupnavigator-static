...
<div class="mk-testimonial mk-script-call mk-flexslider js-flexslider <?php echo $view_params['style']; ?>-style <?php echo $view_params['skin'].'-version '.$view_params['el_class']; ?> <?php echo $view_params['animation_css']; ?> jupiter-donut-clearfix" id="testimonial_<?php echo $view_params['id']; ?>" <?php echo implode(' ', $slide_atts); ?>>
