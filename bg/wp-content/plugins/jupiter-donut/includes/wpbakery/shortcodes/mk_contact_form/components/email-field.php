...
<div class="mk-form-row <?php echo $column_width; ?>">
	...
	<?php endif; ?>	
	<input placeholder="<?php _e( 'Your Email', 'jupiter-donut' ); ?>" class="text-input s_txt-input" type="email" data-type="email" required="required" name="email" value="" tabindex="<?php echo $view_params['tab_index']; ?>" />
</div>