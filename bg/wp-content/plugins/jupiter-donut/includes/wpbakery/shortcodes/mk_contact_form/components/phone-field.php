...
<div class="mk-form-row <?php echo $column_width; ?>">
	...
	<?php endif; ?>	
	<input placeholder="<?php _e( 'Your Phone Number', 'jupiter-donut' ); ?>" class="text-input s_txt-input" type="text" name="phone" value="" tabindex="<?php echo $view_params['tab_index']; ?>" />
</div>