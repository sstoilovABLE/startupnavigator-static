...
extract(
	shortcode_atts(
		array(
			...
			'gdpr_consent'              => 'true',
			'gdpr_consent_text'         => sprintf( __( 'I consent to %s collecting my details through this form.', 'jupiter-donut' ), get_bloginfo( 'name' ) ),
			'visibility'                => '',
		), $atts
	)
);

$list_id = empty( $list_id ) ? jupiter_donut_get_option( 'mailchimp_list_id' ) : $list_id;
