...
<section id="mk-news-section-<?php echo $id; ?>" <?php echo implode(' ', $data_config); ?> class="mk-news-container js-loop jupiter-donut-clearfix <?php echo $el_class . ' jupiter-donut-' . $visibility; ?>">
    <?php
        if ($r->have_posts()):
            while ($r->have_posts()):
                $r->the_post();
