<?php
	...
	$grid_width = jupiter_donut_get_option( 'grid_width' ) - 40;
	...
	if ( $r->have_posts() ) :
		...
		while ( $r->have_posts() ) :
			...
			if ( 'true' == jupiter_donut_get_option( 'blog_single_comments' ) ) {
		...
		if ( $r->found_posts > 1 ) {
			...
			$output .= '<img src="' . Mk_Image_Resize::generate_dummy_image( $image_width, $image_height, true ) . '" style="visibility: hidden; height:' . $image_height . 'px" />';
