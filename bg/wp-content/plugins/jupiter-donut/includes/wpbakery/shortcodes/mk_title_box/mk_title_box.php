...
<h3  id="mk-title-box-<?php echo $id; ?>" class="mk-title-box jupiter-donut-clearfix <?php echo get_viewport_animation_class($animation).$el_class . ' jupiter-donut-' . $visibility; ?>">
