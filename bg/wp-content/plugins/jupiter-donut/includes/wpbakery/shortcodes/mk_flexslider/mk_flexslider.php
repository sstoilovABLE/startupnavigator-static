		...
		<li>
				...
				<?php if(!empty( $caption )) { ?>
					<div class="mk-flex-caption">
						<div style="background-color:<?php echo !empty( $caption_bg_color ) ? $caption_bg_color : jupiter_donut_get_option( 'skin_color' ); ?>; opacity:<?php echo $caption_bg_opacity; ?>;" class="color-mask"></div>
