...
class Mk_Register_Post_Type {
	...
	function register_post_type() {
		...
		if ( isset( $jupiterx['donut_post_types'] ) && empty( $jupiterx['donut_post_types'] ) ) {
			return;
		}

		if ( ! empty( $jupiterx['donut_post_types'] ) && ! in_array( $this->name, $jupiterx['donut_post_types'], true ) ) {
			return;
		}
