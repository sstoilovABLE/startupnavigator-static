...
if ($view_params['pagination_style'] == 1) {
	...
	$init_pagination_id = ( 0 === $init_pagination_id ) ? get_query_var( 'page', 1 ) : $init_pagination_id;
		?>
		<div class="mk-pagination mk-grid js-el jupiter-donut-clearfix" data-init-pagination="<?php echo esc_attr( $init_pagination_id ); ?>" data-number-pages="8" data-max-pages="<?php echo $maxPages; ?>" data-mk-component="Pagination">
				...
				<div class="mk-total-pages">
					<?php esc_html_e( 'page', 'jupiter-donut' ); ?>
					<span class="pagination-current-page js-current-page">1</span>
					<?php esc_html_e( 'of', 'jupiter-donut' ); ?>
...
<div class="js-loadmore-holder jupiter-donut-clearfix">
	<a id="mk_load_more_button" class="mk-loadmore-button js-loadmore-button jupiter-donut-clearfix" href="javascript:;">
		...
		<?php esc_html_e( 'Load More', 'jupiter-donut' ); ?>
	</a>
</div>
<?php }
