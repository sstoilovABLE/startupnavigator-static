...
if ( ! class_exists( 'BFI_Thumb_1_3' ) ) {
    ...
    class BFI_Thumb_1_3 {
        ...
        public static function thumb( $url, $params = array(), $single = true ) {
            ...
            $plugin_url = jupiter_donut()->plugin_url();
            $plugin_dir = jupiter_donut()->plugin_dir();
            ...
            // #2 check if the image is in the current plugin folder
            ...
            $quality = jupiter_donut_get_option( 'image_resize_quality' );
