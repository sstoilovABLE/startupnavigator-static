...
class Parallax_Scroll extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['x'] = [
			'label'   => _x( 'X', 'Parallax Scroll Control', 'raven' ),
			'type'    => 'number',
		];

		$fields['y'] = [
			'label'   => _x( 'Y', 'Parallax Scroll Control', 'raven' ),
			'type'    => 'number',
			'default' => -100,
		];

		$fields['z'] = [
			'label'   => _x( 'Z', 'Parallax Scroll Control', 'raven' ),
			'type'    => 'number',
		];

		$fields['smoothness'] = [
			'label'   => __( 'Smoothness (ms)', 'raven' ),
			'type'    => 'slider',
			'default' => [
				'size' => 30,
			],
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => _x( 'Parallax Scroll', 'Parallax Scroll Control', 'raven' ),
				'starter_name'  => 'type',
				'starter_value' => true,
			],
		];
