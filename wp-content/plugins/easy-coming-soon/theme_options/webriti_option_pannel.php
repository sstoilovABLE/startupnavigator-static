<div class="wrap settings-wrap ecs-container" id="page-settings">
							...
							<form method="post" id="easy-coming-soon_lite_theme_options_5">
									<div id="heading">
										<table style="width:100%;"><tr>
											...
											<br>
											<p><?php echo sprintf (__("In this <a target = '_blank' href ='https://www.youtube.com/watch?v=8qUhLojI_Wg&feature=youtu.be'>video tutorial</a>, I will demonstrate how you can create a fully functional Coming Soon Page in as little as 30 minutes.","easy-coming-soon")); ?></p>
											...
											<?php echo sprintf(__('</p>The premium version is priced at 29 USD and lets you use the plugin on unlimited website.</p><p>Here find the <a target = "_blank" href = "https://www.youtube.com/watch?v=8qUhLojI_Wg&feature=youtu.be"> link to the video </a>demonstrating how to create coming soon page.</p>','easy-coming-soon')); ?>
											</td>
											<td style="width:30%;">
											</td>
											<td style="text-align:right;">					
...
<div class="ecs-sidebar">
	<a href="http://easycomingsoon.com/" target="_blank"><img src="<?php echo plugins_url('/pages/images/img/side-banner.png',__FILE__);?>" alt=""></a> 
</div>
