...
<div class="template">
	...
	<h3 class="template-name">Template5</h3>
	<div class="template-actions">
		<a class="btn btn-danger"  href="http://easycomingsoon.com/"  target= "_new" style="vertical-align:middle;"><?php printf(__('Available In Pro','easy-coming-soon')) ?></a>
	</div>
</div>
...
<div class="template">
		<div class="template-screenshot">
		<span>New</span>
		<a   href="http://easycomingsoon.com/"  target= "_new">	<img src="<?php echo plugins_url('/images/template6.png',__FILE__);?>" alt=""></a>
		</div>
	<h3 class="template-name">Template6</h3>
	<div class="template-actions">
		<a class="btn btn-danger"  href="http://easycomingsoon.com/"  target= "_new" style="vertical-align:middle;"><?php printf(__('Available In Pro','easy-coming-soon')) ?></a>
	</div>
</div>
