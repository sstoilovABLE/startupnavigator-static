...
class WPBakeryShortCode_mk_page_section extends WPBakeryShortCode {
	...
	public function getLayoutsControl() {
		...
		$controls_layout .= '<br/><a class="vc_control-set-column set_columns custom_columns" data-cells="custom" data-cells-mask="custom" title="' . __( 'Custom layout', 'jupiter-donut' ) . '">' . __( 'Custom', 'jupiter-donut' ) . '</a> ';
	...
	public function getColumnControls( $controls, $extended_css = '' ) {
		...
		$controls_move = ' <a class="vc_control column_move vc_column-move" href="#" title="' . __( 'Drag Page Section to reorder', 'jupiter-donut' ) . '" data-vc-control="move"><i class="vc-composer-icon vc-c-icon-dragndrop"></i></a>';
		$controls_add = ' <a class="vc_control column_add vc_column-add" href="#" title="' . __( 'Add column', 'jupiter-donut' ) . '" data-vc-control="add"><i class="vc-composer-icon vc-c-icon-add"></i></a>';
		$controls_delete = '<a class="vc_control column_delete vc_column-delete" href="#" title="' . __( 'Delete this Page Section', 'jupiter-donut' ) . '" data-vc-control="delete"><i class="vc-composer-icon vc-c-icon-delete_empty"></i></a>';
		$controls_edit = ' <a class="vc_control column_edit vc_column-edit" href="#" title="' . __( 'Edit this Page Section', 'jupiter-donut' ) . '" data-vc-control="edit"><i class="vc-composer-icon vc-c-icon-mode_edit"></i></a>';
		$controls_clone = ' <a class="vc_control column_clone vc_column-clone" href="#" title="' . __( 'Clone this Page Section', 'jupiter-donut' ) . '" data-vc-control="clone"><i class="vc-composer-icon vc-c-icon-content_copy"></i></a>';

		$controls_toggle = ' <span class="vc_control vc_row_section_mark" title="' . __( 'Theme Page Section Element', 'jupiter-donut' ) . '">' . __( 'Page Section', 'jupiter-donut' ) . '</span><a class="vc_control column_toggle vc_column-toggle" href="#" title="' . __( 'Toggle Page Section', 'jupiter-donut' ) . '" data-vc-control="toggle"><i class="vc-composer-icon vc-c-icon-arrow_drop_down"></i></a>';
