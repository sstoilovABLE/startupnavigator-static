...
<div id="portfolio-carousel-wrapper-<?php echo esc_attr( $id ); ?>" class="portfolio-carousel style-<?php echo esc_attr( $style ); ?> <?php echo esc_attr( $el_class ) . ' ' . esc_attr( 'jupiter-donut-' . $visibility ); ?>">
