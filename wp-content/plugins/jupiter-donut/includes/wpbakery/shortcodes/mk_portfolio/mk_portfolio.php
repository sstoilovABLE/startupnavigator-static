...
if ( is_singular() ) {
	 ...
	 $layout = jupiter_donut_get_option( 'archive_portfolio_layout' );
}
...
<div class="portfolio-grid <?php echo $ajax_state_class . ' ' . $lazylaod_class . ' jupiter-donut-' . $visibility; ?>">
<?php
...
<?php endif; ?>
	<section id="loop-<?php echo $id; ?>" <?php echo implode( ' ', $data_config ); ?> class="<?php echo implode( ' ', $container_class ); ?> jupiter-donut-clearfix">
