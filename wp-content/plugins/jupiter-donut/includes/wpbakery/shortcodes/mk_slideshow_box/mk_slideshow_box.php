...
<div id="mk-slideshow-box-<?php echo $id; ?>" class="mk-slideshow-box mk-page-section full-width-<?php echo $full_width_cnt; ?> full-height-<?php echo $full_height; ?> <?php echo $el_class . ' jupiter-donut-' . $visibility; ?> <?php if( $full_height == 'true' ) echo 'js-el' ?>" <?php if( $full_height == 'true' ) echo 'data-mk-component="FullHeight"' ?> data-transitionspeed="<?php echo $transition_speed; ?>" data-slideshowspeed="<?php echo $slideshow_speed; ?>">
