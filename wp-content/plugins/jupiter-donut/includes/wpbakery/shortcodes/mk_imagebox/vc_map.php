<?php
vc_map(array(
    "name" => __("Image Box", 'jupiter-donut'),
    "base" => "mk_imagebox",
	'html_template' => dirname( __FILE__ ) . '/mk_imagebox.php',
    'front_enqueue_js' => JUPITER_DONUT_INCLUDES_URL . '/wpbakery/shortcodes/mk_imagebox/vc_front.js',
    ...
    'params' => array(
        ...
        array(
            "type" => "toggle",
            "heading" => __("Slideshow Navigation?", 'jupiter-donut'),
            "param_name" => "scroll_nav",
            "value" => "true",
            "description" => __("This option will give you the ability to turn on/off the slider next/previous navigation.", 'jupiter-donut'),
            "dependency" => array(
                'element' => "show_as",
                'value' => array(
                    'slideshow'
        ...
        array(
            "type" => "range",
            "heading" => __("Slides Per View", 'jupiter-donut'),
            "param_name" => "per_view",
            "value" => "4",
            "min" => "1",
            "max" => "10",
            "step" => "1",
            "unit" => 'slides',
            "description" => __("How many Boxes per view?", 'jupiter-donut'),
            "dependency" => array(
                'element' => "show_as",
                'value' => array(
                    'slideshow'
        ...
        array(
            ...
            "step" => "1",
            "unit" => 'columns',
            "description" => __("If Column based is selected from the option above, you will need to set in how many columns, image boxes will be showed up.", 'jupiter-donut'),
            "dependency" => array(
                'element' => "show_as",
                'value' => array(
                    'column'
        ...
        array(
            "type" => "range",
            "heading" => __("Item Padding", 'jupiter-donut'),
            "param_name" => "padding",
            "value" => "20",
            "min" => "5",
            "max" => "40",
