...
$output = '<div id="mk-pricing-table-'.$id.'" class="shortcode pricing-table '.$style.' '.$el_class . ' jupiter-donut-' . $visibility . ' '.$pricing_offer_css.' new-style">';
if ( strlen( $content ) > 5 ) {
...
Mk_Static_Files::addCSS('#mk-pricing-table-'.$id.'.new-style .pricing-cols .pricing-features ul li {font-size: ' . jupiter_donut_get_option( 'body_font_size' ) . 'px; }', $id);
