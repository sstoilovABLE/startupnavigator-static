...
// Modified function to first check for the add_fragment function. Otherwise a fatal website error occurs. - Stoil Stoilov, 31 August 2025
function jupiterx_child_enqueue_scripts() {
    // Only add fragments if the compiler function exists
